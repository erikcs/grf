...
spp::sparse_hash_map<size_t, double> SampleWeightComputer::compute_weights(size_t sample,
                                                                         const Forest& forest,
...
void SampleWeightComputer::normalize_sample_weights(spp::sparse_hash_map<size_t, double>& weights_by_sample) const {
