...
multi_causal_predict <- function(forest_object, train_matrix, sparse_train_matrix, test_matrix, sparse_test_matrix, num_outcomes, num_treatments, num_threads, estimate_variance) {
    .Call('_grf_multi_causal_predict', PACKAGE = 'grf', forest_object, train_matrix, sparse_train_matrix, test_matrix, sparse_test_matrix, num_outcomes, num_treatments, num_threads, estimate_variance)
}

multi_causal_predict_oob <- function(forest_object, train_matrix, sparse_train_matrix, num_outcomes, num_treatments, num_threads, estimate_variance) {
    .Call('_grf_multi_causal_predict_oob', PACKAGE = 'grf', forest_object, train_matrix, sparse_train_matrix, num_outcomes, num_treatments, num_threads, estimate_variance)
}
...
probability_predict <- function(forest_object, train_matrix, sparse_train_matrix, outcome_index, num_classes, test_matrix, sparse_test_matrix, num_threads, estimate_variance) {
    .Call('_grf_probability_predict', PACKAGE = 'grf', forest_object, train_matrix, sparse_train_matrix, outcome_index, num_classes, test_matrix, sparse_test_matrix, num_threads, estimate_variance)
}

probability_predict_oob <- function(forest_object, train_matrix, sparse_train_matrix, outcome_index, num_classes, num_threads, estimate_variance) {
    .Call('_grf_probability_predict_oob', PACKAGE = 'grf', forest_object, train_matrix, sparse_train_matrix, outcome_index, num_classes, num_threads, estimate_variance)
}
...
survival_predict <- function(forest_object, train_matrix, sparse_train_matrix, outcome_index, censor_index, prediction_type, test_matrix, sparse_test_matrix, num_threads, num_failures) {
    .Call('_grf_survival_predict', PACKAGE = 'grf', forest_object, train_matrix, sparse_train_matrix, outcome_index, censor_index, prediction_type, test_matrix, sparse_test_matrix, num_threads, num_failures)
}

survival_predict_oob <- function(forest_object, train_matrix, sparse_train_matrix, outcome_index, censor_index, prediction_type, num_threads, num_failures) {
    .Call('_grf_survival_predict_oob', PACKAGE = 'grf', forest_object, train_matrix, sparse_train_matrix, outcome_index, censor_index, prediction_type, num_threads, num_failures)
}
